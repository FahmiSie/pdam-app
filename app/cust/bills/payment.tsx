...
import { CreditCard, CheckCircle, Clock, Search as SearchIcon, Receipt, ExternalLink } from "lucide-react";
  ...
  const fetchPayments = useCallback(async (searchValue = "") => {
    ...
    try {
      const res = await fetch(
        `${process.env.NEXT_PUBLIC_BASE_API_URL}/payments/me?page=${page}&quantity=${quantity}&search=${searchValue}`,
        {
          headers: {
